...
public interface ISystemConfig {
     ...
     * 
     * @Title: strConfig   
     * @Description: 字符串的配置信息
     * @author:陈军
     * @date 2019年4月22日 下午12:40:25 
     * @param param 参数名
     * @param def 默认值
     * @return      
     * String      
     ...
     * 
     * @Title: booleanConfig   
     * @Description: 布尔型的配置信息  
     * @author:陈军
     * @date 2019年4月22日 下午12:40:47 
     * @param param 参数名
     * @param def 默认值
     * @return      
     * boolean      
     ...
     * 
     * @Title: intConfig   
     * @Description: int 类型的配置信息 
     * @author:陈军
     * @date 2019年4月22日 下午12:41:19 
     * @param param 参数名
     * @param def 默认值
     * @return      
     * int      
     ...
     * 
     * @Title: doubleCofig   
     * @Description: double型的配置信息 
     * @author:陈军
     * @date 2019年4月22日 下午12:41:48 
     * @param param 参数名
     * @return      
     * Double      
     * @throws
     */
    Double doubleCofig(String param);

    /**
     * 
     * @Title: doubleConfig   
     * @Description: double型的参数配置  
     * @author:陈军
     * @date 2019年4月22日 下午12:42:08 
     * @param param 参数名
     * @param def 默认值
     * @return      
     * double      
     ...
     * 
     * @Title: shortConfig   
     * @Description:short型的配置信息
     * @author:陈军
     * @date 2019年4月22日 下午12:42:41 
     * @param param 参数名
     * @param def 默认值
     * @return      
     * short      
