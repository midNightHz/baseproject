...
public class ThreadLocalUtils {
     ...
     * 
     * @Title: put   
     * @Description:添加参数到线程本地变量  
     * @author:陈军
     * @date 2019年3月13日 下午4:52:41 
     ...
     * 
     * @Title: getParam   
     * @Description: 从线程本地变量中获取参数 
     * @author:陈军
     * @date 2019年3月13日 下午4:53:02 
     * @param paramsName 参数名
     * @return      
     * Object      
     * @throws
     ...
     * 
     * @Title: getParam   
     * @Description: 从线程本地变量中获取参数，如果获取的参数类型和CL不一致时，则返回空 
     * @author:陈军
     * @date 2019年3月13日 下午4:53:30 
     * @param paramsName
     * @param cl
     * @return      
     * T      
